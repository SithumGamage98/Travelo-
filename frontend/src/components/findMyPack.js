...
handleTextSearch=(e)=>{
 ...
 render(){
    ...
    <div>
      ...
      <img class="logo" src={tour} style={{ position:"absolute", right:100,top:240}} height={500} width={600}  alt="Card image cap"></img>
...
<div>
  ...
  <p style={{ position:"absolute", right:100,top:700}}>If you want to change or delete your tour package,please contact package manager!</p>
  <Link to="/all2" style={{ position:"absolute", right:360,top:730}}><button class="btnBack" type="button">Contact manager</button></Link>&nbsp;&nbsp;

  <div class="card-body" style={{ position:"absolute", right:40}} width="700px">
