...
export default class newPack extends Component{
 ...
 render(){
    ...
    return(
     ...
     <a href="/add" class="btn btn-info" style={{width:"300px"}}><strong>Previous page</strong></a>&nbsp;
     <a href="man" class="btn btn-info" style={{width:"300px"}}><strong>Admin's page</strong></a>
