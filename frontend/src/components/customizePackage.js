...
function CusPackage(){
 ...
 return(
   ...
   <div className="container" class="p-4 mb-1 bg-white">
    ...
    <a class="btnHomeFront" href="/front"  style={{ position:"absolute", right:30,top:26}}>Home</a> &nbsp;&nbsp;
     <a class="btnHomeFront" href="findP"  style={{ position:"absolute", right:140,top:26}}>My packages</a>
...
<br></br>
  <div class="card-body" style={{ position:"absolute", right:0,top:900}}>
